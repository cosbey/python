...
**Note:** _Have you already completed this lab once?_ Due to how Coursera handles files, you will need to reset the `login.txt"` file used in this lab to its original contents if you want to complete this lab more than once. The [File contents reset](https://uzjblzvmhyqp.labs.coursera.org/notebooks/Activity_Import%20and%20parse%20a%20text%20file.ipynb#file_contents_reset) section at the end of this notebook contains code that allows you to reset the `login.txt"` file to its original contents. After you have run the code in that section, you can begin the lab again.
...
`login.txtjrafael,192.168.243.140,4:56:27,2022-05-09
